...
export const MovieDetail = () => {
  ...
  const imagePath = movie.poster_path ? `https://image.tmdb.org/t/p/w500/${movie.poster_path}` : Backup;
      ...
      <section className="flex justify-around flex-wrap py-5">
        ...
        <div className="max-w-2xl text-grey-700 text-lg dark:text-white">
          ...
          <div className="flex items-center">
              ...
              <span href="#" className="text-gray-900 dark:text-white">{movie.vote_count}</span>
          </div>
          <p className="my-4">
